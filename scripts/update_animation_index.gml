/// update_animation_index()
 ...
 // Sonic:
    if(character_id = CHAR_SONIC)
    {
       ...
       set_animation("CORKSCREW",  spr_sonic_corkscrew,    0.2,  11, 0, -1, "", 0); 
 ...
 // Tails:
    if(character_id = CHAR_TAILS)
    {
       ...
       set_animation("BORED_1",         spr_miles_idle, 0.20, 70, 0, -1, "", 0);         
       ...
       set_animation("TORNADO",      spr_miles_tornado, 0.15,  4, 0, -1, "", 0);   
       set_animation("TORNADO FAST", spr_miles_tornado_fast, 0.15,  2, 0, -1, "", 0);   
       set_animation("WIN",              spr_miles_win,  0.3, 21, 21, 0, "", 0);  
    }
 ...
 // Knuckles:
    if(character_id = CHAR_KNUX)
    {
       ...
       set_animation("BORED_1",            spr_knuckles_idle_1, 0.2, 9, 0, 12, "BORED_2", 0);    
       set_animation("BORED_2",            spr_knuckles_idle_2, 0.20, 24, 0, -1, "BORED_2", 0);        
       ...
       set_animation("CLIMB UP",         spr_knuckles_climb_up, 0.25,  5, 0, -1, "", 0);  
       ...
       set_animation("MEGA",                 spr_knuckles_mega, 0.15,  5, 0, 0, "", 0);     
       set_animation("WIN",                spr_knuckles_win,     0.1,  2, 0, -1, "", 0);                                       
    }    
