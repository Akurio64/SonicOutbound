/// update_animation_index()
 ...
 // Sonic:
    ...
    {
       set_animation("STAND",          spr_sonic_stand_new,    0,  0, 0, -1, "", 0);
       set_animation("BORED_1",       spr_sonic_idle_1_new, 0.25, 13, 8, 12, "BORED_2", 0);    
       set_animation("BORED_2",       spr_sonic_idle_2_new, 0.25, 13, 9, -1, "BORED_2", 0);        
       set_animation("LOOK",         spr_sonic_look_up_new, 0.35,  4, 0,  0, "", 0);    
       set_animation("LOOK_END",    spr_sonic_look_end_new, 0.18,  1, 0,  0, "STAND", 0);            
       set_animation("CROUCH",        spr_sonic_crouch_new, 0.6,   3, 0,  0, "", 0);    
       set_animation("CROUCH_UP",  spr_sonic_crouch_up_new, 0.40,  1, 0,  0, "STAND", 0);   
       set_animation("PUSH",            spr_sonic_push_new, 0.15,  9, 0, -1, "", 0);         
       set_animation("WALK",            spr_sonic_walk_new, 0.25, 11, 0, -1, "", 0); 
       set_animation("JOG",              spr_sonic_jog_new, 0.25,  9, 0, -1, "", 0);    
       set_animation("RUN",              spr_sonic_run_new, 0.25,  7, 0, -1, "", 0);  
       set_animation("DASH",            spr_sonic_dash_new, 0.25,  4, 1, -1, "", 0);      
       set_animation("PEELOUT",      spr_sonic_peelout_new, 0.60,  4, 1, -1, "", 0);          
       set_animation("ROLL",            spr_sonic_roll_new, 0.5,  15, 0, -1, "", 0);
       set_animation("SPINDASH",    spr_sonic_spindash_new, 0.8,  15, 0, -1, "", 0);
       set_animation("DROPDASH",    spr_sonic_dropdash_new,   1,  15, 0, -1, "", 0); 
       set_animation("SPRING",        spr_sonic_spring_new, 0.15,  1, 0, -1, "", 0);                 
       set_animation("TWIRL",          spr_sonic_twirl_new, 0.5,  9, 0, -1, "", 0);         
       set_animation("SKID",            spr_sonic_skid_new, 0.35,  8, 5,  0, "", 0); 
       set_animation("SKID TURN",  spr_sonic_skid_turn_new, 0.25,  2, 0,  0, "", 0);             
       set_animation("BALANCE",    spr_sonic_balance_1_new, 0.20,  7, 0, -1, "", 0); 
       set_animation("BALANCE 2",  spr_sonic_balance_2_new, 0.20,  7, 0, -1, "", 0);        
       set_animation("HURT",            spr_sonic_hurt_new, 0.18,  4, 3, -1, "", 0); 
       set_animation("BREATHE",      spr_sonic_breathe_new, 0.20,  5, 0,  0, "WALK", 0);              
       set_animation("DEATH",          spr_sonic_death_new,    0,  0, 0, -1, "", 0);        
       set_animation("DROWN",          spr_sonic_drown_new,    0,  0, 0, -1, "", 0);    
    }
