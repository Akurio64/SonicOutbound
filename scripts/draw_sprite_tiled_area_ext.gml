/// draw_sprite_tiled_area_ext(sprite,subimg,x,y,x1,y2,x2,y2,xscale,yscale,alpha)
//
...
/// GMLscripts.com/license
{
    ...
    for(i=i; i<=x2; i+=sw) {
        for(j=j; j<=y2; j+=sh) {
            ...
            draw_sprite_part_ext(sprite,subimg,left,top,width,height,X,Y,argument8,argument9,c_white,argument10);
        }
        j = jj;
    }
    return 0;
