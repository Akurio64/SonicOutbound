...
if(state == CS_ROLL){
   ...
   if (x_speed <= 3) wall_handle = character_collision_check(COL_LEFT_OBJECT, MASK_BIG, x, y, angle, par_break_walls);
   if (x_speed >= 3) wall_handle = character_collision_check(COL_RIGHT_OBJECT, MASK_BIG, x, y, angle, par_break_walls);
